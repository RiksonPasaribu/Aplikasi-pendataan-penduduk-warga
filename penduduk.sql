...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 04, 2021 at 05:24 PM
...
INSERT INTO `tbl_kab` (`id_kab`, `id_prov`, `kabupaten`) VALUES
(1101, 11, 'KAB. ACEH SELATAN'),
(1102, 11, 'KAB. ACEH TENGGARA'),
(1103, 11, 'KAB. ACEH TIMUR'),
(1104, 11, 'KAB. ACEH TENGAH'),
...
INSERT INTO `tbl_kecamatan` (`id_kec`, `id_kab`, `kecamatan`) VALUES
(3, 7173, 'Kec. Tomohon Utara'),
(6, 7173, 'Kec. Tomohon Tengah'),
(7, 7173, 'Kec. Tomohon Timur'),
(8, 7173, 'Kec. Tomohon Selatan'),
(9, 7173, 'Kec. Tomohon Barat');
...
INSERT INTO `tbl_kelurahan` (`id_kel`, `id_kec`, `kelurahan`) VALUES
(1, 9, 'Taratara'),
(2, 9, ' Taratara I'),
(3, 9, ' Taratara II');
...
CREATE TABLE `tbl_lingkungan` (
  ...
  `no_lingkungan` char(40) NOT NULL,
  `lingkungan` char(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_lingkungan` (`id_lingkungan`, `id_kel`, `no_lingkungan`, `lingkungan`) VALUES
(1, 1, '0097', 'Lingkungan 1'),
(2, 1, '00976', 'Lingkungan 2'),
(3, 1, '0988', 'Lingkungan 3');
...
CREATE TABLE `tbl_login` (
  ...
  `id_kec` int(20) NOT NULL,
  `id_kel` int(20) NOT NULL,
  `id_lingkungan` int(20) NOT NULL,
  `noHp` char(60) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_login` (`id_login`, `username`, `password`, `level`, `id_prov`, `id_kab`, `id_kec`, `id_kel`, `id_lingkungan`, `noHp`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', 71, 0, 0, 0, 0, ''),
(2, 'user', 'ee11cbb19052e40b07aac0ca060c23ee', 'user', 71, 0, 0, 0, 0, ''),
(5, 'users1', 'b2255c5d029d69e44374a99e9d03921d', 'user', 71, 7173, 9, 1, 1, '854445677'),
(6, 'users2', '86425c35a33507d479f71ade53a669aa', 'user', 71, 7173, 9, 1, 2, '');
...
INSERT INTO `tbl_meninggal` (`id_meninggal`, `nik`, `tanggalMeninggal`, `id_lingkungan`) VALUES
(7, 1789999, '2021-08-03', 1);
...
INSERT INTO `tbl_pendatang` (`id_pendatang`, `nik`, `asal`, `tanggalDatang`) VALUES
(1, 17678889, 'Ciamis', '2021-08-03'),
(2, 17678888, 'Jaksel', '2021-08-03');
...
CREATE TABLE `tbl_penduduk` (
  ...
  `statusKawin` char(40) NOT NULL,
  `pekerjaan` char(50) NOT NULL,
  `pendidikan` char(50) NOT NULL,
  `agama` char(40) NOT NULL,
  `lingkungan` text NOT NULL,
  `id_kel` int(20) NOT NULL,
  `id_kec` int(20) NOT NULL,
  `id_kab` int(20) NOT NULL,
  `id_prov` int(20) NOT NULL,
  `negara` char(50) NOT NULL,
  `status` enum('tetap','pindah','pendatang','meninggal','lahiran') NOT NULL,
  `usia` int(11) NOT NULL,
  `noKK` int(50) NOT NULL,
  `statusKeluarga` enum('Kepala Keluarga','Istri','Anak') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_penduduk` (`id_penduduk`, `nik`, `nama`, `tempatLahir`, `tanggalLahir`, `jk`, `statusKawin`, `pekerjaan`, `pendidikan`, `agama`, `lingkungan`, `id_kel`, `id_kec`, `id_kab`, `id_prov`, `negara`, `status`, `usia`, `noKK`, `statusKeluarga`) VALUES
(3, 567899, 'Fadillah', 'langsa', '1996-08-18', 'pria', 'Belum Menikah', '1', 'S1', 'Islam', '1', 1, 9, 7173, 71, 'WNI', 'tetap', 24, 1006788894, 'Kepala Keluarga'),
(4, 6555578, 'naskal', 'langsa', '1997-12-18', 'pria', 'Belum Menikah', '2', 'S1', 'Islam', '2', 1, 9, 7173, 71, 'WNI', 'pindah', 23, 19099767, 'Anak'),
(5, 68768888, 'Ayu Lestari', 'Manado', '1998-10-19', 'wanita', 'Belum Menikah', '1', 'S1', 'Islam', '2', 1, 9, 7173, 71, 'WNI', 'tetap', 22, 19099767, 'Istri'),
(6, 2147483647, 'andi cehng', 'NTT', '1997-12-10', 'pria', 'Belum Menikah', '1', 'S1', 'Islam', '2', 1, 9, 7173, 71, 'WNI', 'tetap', 23, 19099767, 'Anak'),
(7, 1789999, 'mumu', 'semarang', '1999-10-10', 'pria', 'Belum Menikah', '3', 'SMP', 'Islam', '1', 1, 9, 7173, 71, 'WNI', 'meninggal', 21, 1006788894, 'Anak'),
(8, 2147483647, 'pipinhg', 'lmedan', '2001-10-10', 'pria', 'Belum Menikah', '1', 'SMP', 'Islam', '1', 1, 9, 7173, 71, 'WNI', 'tetap', 19, 2147483647, 'Anak'),
(9, 76758768, 'Aflal', 'medan', '1999-01-09', 'pria', 'Belum Menikah', '5', 'SD', 'Islam', '2', 1, 9, 7173, 71, 'WNI', 'tetap', 22, 19099767, 'Anak'),
(10, 767667, 'Rea', 'medan', '0000-00-00', 'pria', 'Belum Menikah', '5', 'S1', 'Islam', '2', 1, 9, 7173, 71, 'WNI', 'tetap', 0, 19099767, 'Kepala Keluarga'),
(11, 2147483647, 'Fahri Ksp', 'sumedang', '1887-12-10', 'pria', 'Menikah', '4', 'S1', 'Islam', '2', 1, 9, 7173, 71, 'WNI', 'tetap', 133, 2147483647, 'Kepala Keluarga'),
(12, 6555578, 'naskal', 'langsa', '1997-12-18', 'pria', 'Belum Menikah', '2', 'S1', 'Islam', '2', 1, 9, 7173, 71, 'WNI', 'pindah', 23, 19099767, 'Anak'),
(14, 516172172, 'Imel', 'Langsa', '2021-08-03', 'wanita', 'Belum Menikah', '1', 'SD', 'Islam', '1', 1, 9, 7173, 71, 'WNI', 'lahiran', 0, 2147483647, 'Anak'),
(15, 17678889, 'rey Pranata', 'Bogor', '2000-10-19', 'pria', 'Menikah', '1', 'SD', 'Islam', '1', 1, 9, 7173, 71, 'WNI', 'pendatang', 20, 6546556, 'Kepala Keluarga'),
(17, 1177888, 'HALIMAH', '', '0000-00-00', 'pria', 'Belum Menikah', '2', 'S1', 'Islam', '1', 1, 9, 7173, 71, 'WNI', 'tetap', 0, 6546556, 'Istri'),
(19, 11113121, 'Riska', 'Manado', '1999-09-10', 'wanita', 'Belum Menikah', '8', 'SMA', 'Islam', '2', 1, 9, 7173, 71, 'WNI', 'tetap', 21, 2147483647, 'Istri'),
(20, 1212131, 'frince', 'makasar', '2021-08-04', 'pria', 'Belum Menikah', '11', 'Tidak Sekolah', 'Islam', '2', 1, 9, 7173, 71, 'WNI', 'lahiran', 0, 2147483647, 'Anak'),
(21, 12121212, 'Fina', 'Manado', '2021-08-04', 'wanita', 'Belum Menikah', '11', 'Tidak Sekolah', 'Islam', '2', 1, 9, 7173, 71, 'WNI', 'lahiran', 0, 788888888, 'Anak');
...
INSERT INTO `tbl_pindah` (`id_pindah`, `nik`, `pindahKe`, `id_lingkungan`) VALUES
(5, 6555578, 'Bekasi Luar Kota', 2),
(6, 1789999, 'Bekasi Luar Kota', 1);
...
INSERT INTO `tbl_umur` (`id_umur`, `dari`, `sampai`) VALUES
(1, 1, 5),
(2, 6, 10),
(3, 11, 15),
(5, 16, 20),
...
--
ALTER TABLE `tbl_kelurahan`
  MODIFY `id_kel` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbl_lingkungan`
--
ALTER TABLE `tbl_lingkungan`
  MODIFY `id_lingkungan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tbl_pendatang`
  MODIFY `id_pendatang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tbl_umur`
  MODIFY `id_umur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
