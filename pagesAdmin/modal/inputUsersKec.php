<!-- Modal -->
<div class="modal fade" id="exampleModalUsersKec" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Input Users Kecamatan </h5>
            ...
            <form action="" method="POST">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_kec" id="id_kec" class="form-control show-tick" required />
                ...
                <div class="modal-footer">
                    <button type="submit" name="inputUserKec" class="btn btn-primary">Simpan User</button>
